...
from ..services import notifications, ratelimit
from ..services.reference import assign_reference_code
...
def create_booking(
    ...
    with _booking_lock:
        ...
        db.add(booking)
        booking.reference_code = assign_reference_code(db, booking)
        db.commit()
        db.refresh(booking)
